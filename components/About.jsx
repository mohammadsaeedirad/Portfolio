...
const About = () => {
  ...
  <div id='about' className="container about my-20 mx-auto p-4 md:p-0">
  
  <div  className=" p-2 flex flex-wrap w-full lg:w-4/5 mx-auto"> 
    <div className="bg-cover opacity-80 bg-bottom w-full md:w-1/3 h-96 md:h-90  relative" style={{backgroundImage:"url('profile.jpg')",backgroundPosition:"center center"}}>
   
    </div>
    
    <div className="about w-full md:w-2/3">
      <div className="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
        <div className="about-card lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
          ...
          <div className="w-full h-52 lg:w-3/5 lg:px-3">
            ...
            as you know my name is mohammad and I'm graduated at <a href='https://iau.ir/fa' className='text-yellow-500' >islamic azad uneversity</a>  with bachelor degree of computer engineering.
            </p>
          ...
          <div className="w-full lg:w-1/5 mt-6 lg:mt-0 lg:px-4 text-center md:text-left">
            <a  href="https://www.linkedin.com/in/mohammad-saeedi-rad-54b2341b7/" className="px-2 about hover:bg-sky-900 hover:text-white  w-1/3 lg:w-full py-2">LinkedIn</a>
          </div>
        </div>
      </div>
    </div>
